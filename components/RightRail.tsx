...
export default function RightRail() {
  ...
  useEffect(() => {
    ...
    async function loadDictionary() {
      ...
      try {
        ...
        const items: DictTerm[] = snap.docs.map((d) => ({
          id: d.id,
          ...(d.data() as any),
        }));
  ...
  return (
    <div className="w-full bg-[#E8F3FA] rounded-2xl p-6 space-y-4">
      {/* Unlocked Avatars Section (keep as-is for now) */}
      <div>
        ...
        >
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="text-white">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.5 3.5C6.5 3.22386 6.72386 3 7 3H13C13.2761 3 13.5 3.22386 13.5 3.5V9C13.5 9.27614 13.2761 9.5 13 9.5C12.7239 9.5 12.5 9.27614 12.5 9V4.70711L3.85355 13.3536C3.65829 13.5488 3.34171 13.5488 3.14645 13.3536C2.95118 13.1583 2.95118 12.8417 3.14645 12.6464L11.7929 4H7C6.72386 4 6.5 3.77614 6.5 3.5Z"
              fill="currentColor"
            />
          </svg>
        </button>
