...
function LessonCard({ title, category, imageUrl, progress }: LessonCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden cursor-pointer hover:shadow-md transition-all relative">
      {/* Image Section */}
      <div className="relative h-28 bg-gray-100">
        ...
        />
        {/* Heart Button */}
        <button className="absolute top-3 right-3 w-5 h-5 bg-black/30 rounded-full flex items-center justify-center hover:bg-black/40 transition-all">
      ...
      <div className="p-3">
        ...
        <div className="inline-flex items-center px-3 py-1 bg-[#04456d]/10 rounded-lg mb-2">
          <span className="text-[#04456d] text-xs font-normal uppercase tracking-wider">
            {category}
          </span>
        </div>
        
        <h3 className="font-medium text-sm text-gray-900 leading-relaxed mb-2">
          {title}
        </h3>
    ...
    <section>
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex gap-3">
          <button className="w-6 h-6 rounded-full border border-gray-400 flex items-center justify-center hover:bg-gray-50 transition">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7.49992 9.96004L4.23992 6.70004C3.85492 6.31504 3.85492 5.68504 4.23992 5.30004L7.49992 2.04004" stroke="#9E9E9E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          <button className="w-6 h-6 rounded-full border border-gray-400 flex items-center justify-center hover:bg-gray-50 transition">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.45508 9.96004L7.71508 6.70004C8.10008 6.31504 8.10008 5.68504 7.71508 5.30004L4.45508 2.04004" stroke="#9E9E9E" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
      </div>
      ...
      lessons: [
        {
          title: "Lesson 1",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/f221e6d99cd3158d8054c9605d8f732f07fe4c26?width=515",
          progress: 51
        },
        {
          title: "Lesson 2",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/414987ec755eaaa272fc75ca4e23a57b4a83f610?width=515",
          progress: 51
        },
        {
          title: "Lesson 3",
          category: "Stocks",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/c51f22ead4ee69af5fd0b30b6e204a61a3fffc00?width=515",
          progress: 51
        }
      ]
    },
      ...
      lessons: [
        {
          title: "Lesson 1",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/d12d578fb90d73965d8b5333badb254499486b3d?width=515",
          progress: 51
        },
        {
          title: "Lesson 2",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/d1ad6dec60e5a03521df295a24faee116424d681?width=515",
          progress: 51
        },
        {
          title: "Lesson 3",
          category: "Stocks",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/1bdb87f4905f1bf978f5faa9e9654d1892bfc7fa?width=515",
          progress: 51
        }
      ]
    },
      ...
      lessons: [
        {
          title: "Lesson 1",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/7ecf44d31a9e2f936f3b957ce4b7f93dd95d7fa2?width=515",
          progress: 51
        },
        {
          title: "Lesson 2",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/acb725f3f86f965dd026a61661145caf37d68231?width=515",
          progress: 51
        },
        {
          title: "Lesson 3",
          category: "Stocks",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/2746cae0ae4cb0d6fda16603ef4887ac5ad6d641?width=515",
          progress: 51
        }
      ]
    },
      ...
      lessons: [
        {
          title: "Lesson 1",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/3f0ff33d7122ae2536ca66f24a4feff12f41703d?width=515",
          progress: 51
        },
        {
          title: "Lesson 2",
          category: "Savings",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/2bffdbaaa7066d288d28dec2d792c1460c7ac58e?width=515",
          progress: 51
        },
        {
          title: "Lesson 3",
          category: "Stocks",
          imageUrl: "https://api.builder.io/api/v1/image/assets/TEMP/fd9756af4aeed573522c2e899816ec55c77b1d62?width=515",
          progress: 51
        }
      ]
    }
          ...
          <div className="flex flex-col gap-6 pt-5">
            {moduleData.map((module, index) => (
              <div key={module.moduleNumber}>
                ...
                />
                {/* Add divider between modules except after the last one */}
