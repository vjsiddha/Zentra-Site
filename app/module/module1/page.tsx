...
function ModuleOneContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F7FAFC] font-manrope text-[#0D171C]">
      ...
      {/* LESSON 3: Apply to Real Scenarios */}
      {activeStep === 3 && (
        <L3_Applying
          onComplete={(score) => {
        ...
        <section className="min-h-screen flex items-center justify-center px-6">
          <div className="max-w-xl w-full bg-white p-12 rounded-[40px] shadow-xl border border-slate-100 text-center animate-in zoom-in duration-500">
            ...
            <p className="text-lg text-[#4F7D96] mb-8 leading-relaxed">
              Congratulations! You've mastered the basics of budgeting and financial planning.
            </p>
            ...
            <div className="mb-8">
              <div className="flex justify-between text-sm mb-2">
                <span className="font-bold text-slate-700">Module 1 Progress</span>
