...
const DEFINITIONS: Definition[] = [
  {
    ...
    term: "Portfolio",
    subtitle:
      "Your investments + the weights (percentages) — includes stocks, ETFs (Exchange-Traded Funds), bonds, cash, and more",
    definition:
    ...
    deeper:
      'Portfolios are about tradeoffs: more growth potential usually means more short-term swings. The goal is not "max return," it is "best return for the risk + time horizon you can tolerate."',
    example:
  ...
  },
  {
    ...
    deeper:
      "Stocks can be excellent long-term assets — but they are concentrated. One company can underperform for years, even if the market overall does well.",
    example:
    ...
    takeaway:
      'Stocks are not "bad" — they are just more sensitive to company-specific outcomes.',
    image:
  ...
  },
  {
    ...
    term: "ETF",
    subtitle:
      "Exchange-Traded Fund — a basket of assets you can trade like a stock",
    definition:
      "ETF stands for Exchange-Traded Fund. It bundles many investments — such as stocks, bonds, or other securities — into one product that trades on a stock exchange like a single share. Many ETFs track an index (like a market benchmark), giving you broad diversification in one purchase.",
    deeper:
  ...
  },
  {
    ...
    term: "Bond",
    subtitle:
      "A loan you give to a company or government — they pay you interest",
    definition:
      "A bond is a fixed-income security. When you buy a bond, you're lending money to the issuer (a company or government) in exchange for regular interest payments (called a coupon) and the return of your original amount at the end of the term (called maturity).",
    deeper:
      "Bonds are generally less volatile than stocks because the payments are contractually fixed — but they are not risk-free. If interest rates rise, existing bond prices fall. If the issuer cannot pay, you may lose money. Bond ETFs bundle many bonds together so you get diversified exposure without needing to hold individual bonds.",
    example:
      "A 2-year government bond paying 4% annually: you lend $1,000, receive $40/year in interest, and get your $1,000 back at the end. Lower risk than stocks, but lower potential upside too.",
    takeaway:
      "Bonds add stability and income to a portfolio — but like all assets, they carry their own risks (interest rate risk, credit risk).",
    image:
  ...
  },
  {
    ...
    definition:
      "A mutual fund pools money from many investors and invests it across a mix of stocks, bonds, and other securities — giving you more diversification and reduced single-company risk compared to holding individual assets. Many mutual funds are actively managed: professionals choose what to buy/sell aiming to outperform a benchmark.",
    deeper:
      "Active management is not automatically wrong — but fees create a hurdle. If a fund charges about 2% per year, it needs to outperform by about 2% per year just to match a low-fee alternative. Because the fund holds many securities, you get built-in diversification, but that does not mean the fund itself is low-risk.",
    example:
      "If the market returns 7%, and a fund returns 7% before fees but charges 2%, you keep about 5%. That gap compounds over time.",
    takeaway:
  ...
  },
  {
    ...
    definition:
      'Risk is not just "losing money." In investing it usually means uncertainty: how wide the range of possible outcomes is, and how much returns can swing.',
    deeper:
  ...
  },
  {
    ...
    deeper:
      "Short horizons make volatility dangerous — you might be forced to sell during a drop. Longer horizons increase the chance you can recover from downturns (but do not eliminate risk).",
    example:
  ...
  },
  {
    ...
    definition:
      "Diversification means spreading money across different assets so one outcome does not dominate your results.",
    deeper:
      "Real diversification is about correlation: if your assets tend to fall together, you are less protected. Diversifying across sectors, regions, and asset types helps reduce this.",
    example:
    ...
    image:
      "https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?q=80&w=1200",
  },
  {
    id: 9,
    ...
    definition:
      "MER is the annual fee charged by funds. You do not pay it like a bill — it is deducted inside the fund, lowering what you keep.",
    deeper:
      "Fees do not just reduce returns once — they reduce the amount that can compound. Over decades, a 1–2% fee gap can become a huge difference in final wealth.",
    example:
...
const CHALLENGES: Challenge[] = [
  {
    ...
    whyItMatters:
      "You are not buying the label — you are buying the underlying holdings and concentration.",
  },
  {
    id: 2,
    statement: '"Higher fees usually mean better performance."',
    correct: "false",
    nuanceTitle: "Fees are guaranteed; outperformance is not.",
    nuance:
      "A higher MER is certain, but beating the market consistently is hard. Fees create a performance hurdle that many funds do not clear after costs.",
    whyItMatters:
  ...
  },
  {
    ...
    correct: "true",
    nuanceTitle: "Short horizons cannot wait out big drops.",
    nuance:
  ...
  },
  {
    ...
    nuance:
      "Diversification helps protect you from one disaster, but also means you will not fully capture the upside of the single best performer.",
    whyItMatters:
...
export default function L1_Definitions({
  ...
  const [view, setView] = useState<"intro" | "study" | "challenge" | "results">(
    "intro"
  );
  ...
  const showBackButton =
    view === "intro" || view === "study" || (view === "challenge" && !lockedChoice);
  ...
  const feedback = useMemo(() => {
    if (percentage >= 85) {
      return {
        ...
        msg:
          'You are thinking like an investor: labels are not enough, fees matter, and time horizon changes what "risky" means. That is a strong foundation.',
    ...
    if (percentage >= 60) {
      return {
        ...
        msg:
          "Good instincts. Review ETF concentration and the difference between short-term vs long-term risk — then you are set for simulations.",
        color: "text-sky-600",
      ...
      <div className="relative flex flex-col items-center justify-center max-w-[960px] mx-auto px-6 pt-16 animate-in fade-in slide-in-from-bottom-4">
        <div className="w-full text-center mb-6">
          ...
          <p className="text-slate-500 text-sm mt-2">
            Lesson 1: Definitions + real-world misconceptions
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm text-[#4F7D96]">
              Portfolio, assets, risk, diversification, fees
            </p>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm text-[#4F7D96]">
              Why the "obvious" answer is sometimes wrong
            </p>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm text-[#4F7D96]">
              True / False / It Depends — with real explanations
            </p>
          </div>
        </div>
        ...
        <p className="text-center mb-10 max-w-2xl text-[#0D171C]">
          ...
          <span className="font-semibold">and</span> the mental models: weights,
          time horizon, concentration vs diversification, and why fees quietly matter.
        </p>

        <button
          onClick={() => setView("study")}
          className="px-10 py-4 bg-[#0B5E8E] text-white rounded-full font-bold"
        >
          Start Learning
        </button>
      </div>
  ...
  if (view === "challenge") {
    ...
    const ChoiceButton = ({
      ...
      if (lockedChoice && isCorrect)
        style = "border-green-500 bg-green-50 text-green-800";
      if (lockedChoice && isChosen && value !== c.correct)
      ...
      return (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            {lockedChoice && isCorrect && (
              <span className="font-black text-green-700">✓</span>
            )}
            {lockedChoice && isChosen && value !== c.correct && (
        ...
        <section className="animate-in zoom-in duration-300 max-w-3xl mx-auto pt-16">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-md border border-slate-100">
            <div className="p-6 rounded-2xl bg-slate-900 text-white mb-6">
              <p className="text-xs uppercase tracking-widest text-slate-200 font-bold mb-2">
                Statement
              </p>
            ...
            {lockedChoice && (
              <div
                className={`mt-6 p-6 rounded-2xl border-2 animate-in fade-in slide-in-from-top-2 duration-300 ${correctnessTag?.cls}`}
              >
            ...
            {!passedLesson && (
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-left">
                <p className="text-sm text-amber-800">
                  <strong>Keep going:</strong> You need at least <strong>50%</strong>{" "}
                  on Lesson 1 before moving to Lesson 2.
                </p>
              </div>
            )}
