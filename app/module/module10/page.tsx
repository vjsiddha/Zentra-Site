...
function ModuleTenContent() {
  ...
  const goToStep = (step: number) => {
    setActiveStep(step);
    router.push(`/module/module10?step=${step}`, { scroll: false });
  };
        ...
        <section className="min-h-screen flex items-center justify-center px-6">
          <div className="max-w-xl w-full bg-white p-12 rounded-[40px] shadow-xl border border-slate-100 text-center animate-in zoom-in duration-500">
            ...
            <p className="text-lg text-[#4F7D96] mb-8 leading-relaxed">
              You explored behavioral biases, practiced spotting common investor mistakes, and built a stronger long-term investing mindset.
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-pink-50 rounded-xl p-4">
                ...
                <p className="text-2xl font-black text-pink-700">{lesson1Score}%</p>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="h-4 bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-pink-500 via-emerald-500 to-violet-500 w-full" />
              </div>
            </div>
...
export default function ModuleTenPage() {
  return (
    <Suspense
      fallback={
