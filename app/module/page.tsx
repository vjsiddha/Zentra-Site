...
function LessonCard({ 
...
}: LessonCardProps & { gradient: string; textColor: string; inProgressMessage: string; progressIcon: any }) {
  ...
  const card = (
    ...
    >
      {/* Completion Badge */}
      {isCompleted && (
        <div className="absolute top-3 right-3 z-20 bg-yellow-400 rounded-full p-2 shadow-lg animate-bounce">
      ...
      <div className="p-5">
        ...
        <div className="space-y-2">
          ...
          {/* Progress text with motivational messages and icons */}
...
function ModuleSection({ moduleNumber, moduleTitle, moduleIcon: ModuleIcon, lessons, gradient, textColor, inProgressMessage, progressIcon }: ModuleSectionProps) {
...
export default function LessonPage() {
  ...
  const moduleData: ModuleData[] = [
    {
      ...
      lessons: [
        { title: "First Job & Budgeting Basics", category: "Learn", icon: Calculator, progress: 0, href: "/module/module1?step=1", xp: 100 },
        { title: "Build Your Budget", category: "Practice", icon: Sliders, progress: 0, href: "/module/module1?step=2", xp: 150 },
        { title: "Real Life Scenarios", category: "Master", icon: Briefcase, progress: 0, href: "/module/module1?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 2,
      ...
      lessons: [
        { title: "Stocks, ETFs & More", category: "Learn", icon: BookOpen, progress: 0, href: "/module/module2?step=1", xp: 100 },
        { title: "Simulate Investing", category: "Practice", icon: TrendingUp, progress: 0, href: "/module/module2?step=2", xp: 150 },
        { title: "Pick Your Strategy", category: "Master", icon: Target, progress: 0, href: "/module/module2?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 3,
      ...
      lessons: [
        { title: "Crypto Fundamentals", category: "Learn", icon: Lock, progress: 0, href: "/module/module3?step=1", xp: 100 },
        { title: "Make Smart Decisions", category: "Practice", icon: Gamepad2, progress: 0, href: "/module/module3?step=2", xp: 150 },
        { title: "Build Your Plan", category: "Master", icon: Rocket, progress: 0, href: "/module/module3?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 4,
      ...
      lessons: [
        { title: "Understanding Bear Markets", category: "Learn", icon: TrendingDown, progress: 51, href: "/module/module4?step=1", xp: 100 },
        { title: "Handle the Drop", category: "Practice", icon: Activity, progress: 51, href: "/module/module4?step=2", xp: 150 },
        { title: "Stay Calm & Win", category: "Master", icon: Target, progress: 51, href: "/module/module4?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 5,
      ...
      lessons: [
        { title: "Passive vs Active", category: "Learn", icon: BookOpen, progress: 51, href: "/module/module5?step=1", xp: 100 },
        { title: "Compare Strategies", category: "Practice", icon: BarChart3, progress: 51, href: "/module/module5?step=2", xp: 150 },
        { title: "Choose Your Path", category: "Master", icon: PieChart, progress: 51, href: "/module/module5?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 6,
      ...
      lessons: [
        { title: "Sectors & Themes", category: "Learn", icon: Building2, progress: 0, href: "/module/module6?step=1", xp: 100 },
        { title: "Build Your Mix", category: "Practice", icon: TrendingUp, progress: 0, href: "/module/module6?step=2", xp: 150 },
        { title: "Balance Risk", category: "Master", icon: Target, progress: 0, href: "/module/module6?step=3", xp: 200 },
      ],
    },
    {
      moduleNumber: 7,
      ...
      lessons: [
        { title: "Time Beats Timing", category: "Learn", icon: Clock, progress: 51, href: "/module/module7?step=1", xp: 100 },
        { title: "See Compound Growth", category: "Practice", icon: BarChart3, progress: 5, href: "/module/module7?step=2", xp: 150 },
        { title: "Start Now", category: "Master", icon: Target, progress: 51, href: "/module/module7?step=3", xp: 200 },
      ],
    },
  ];
  ...
  const totalProgress = Math.round(
    mergedModuleData.reduce((sum, m) => 
      sum + m.lessons.reduce((s, l) => s + l.progress, 0) / m.lessons.length, 0
