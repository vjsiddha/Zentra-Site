...
function InvestmentChart({ data, title }: { data: { month: number; value: number }[]; title: string }) {
            ...
            {messages.length === 0 ? (
              <div className="text-center py-16">
                <div className="flex justify-center mb-4">
                  <img src="/benny_avatar.png" alt="Benny" className="w-20 h-20 object-contain" />
                </div>
                <p className="text-slate-600 font-medium mb-2 text-lg">Hi! I'm Benny</p>
                <p className="text-sm text-slate-500 mb-8">Ask me investment "what if" questions!</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-5 rounded-xl bg-slate-50">
                  ...
                  <p className="text-2xl font-bold text-slate-900">${simulation.summary.totalInvested.toLocaleString()}</p>
                </div>
                <div className="p-5 rounded-xl bg-slate-50">
                  <p className="text-xs text-slate-500 mb-2">Final Portfolio Value</p>
                  <p className="text-2xl font-bold text-slate-900">${Math.round(simulation.summary.finalValue).toLocaleString()}</p>
                </div>
